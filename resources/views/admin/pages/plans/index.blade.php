...
@section('content_header')
    ...
    <h1>Planos <a class="btn btn-dark" href="{{route('plans.create')}}"><i class="fas fa-plus"></i> Adicionar novo Plano </a></h1>
@stop
            ...
            <table class="table table-condensed">
                ...
                @foreach($plans as $plan)
                    <tr>
                        ...
                        <td style="width: 10px">
                            <a href="{{route('plans.show', $plan->url)}}" class="btn btn-info">Ver detalhes</a>
                            <a href="{{route('plans.edit', $plan->url)}}" class="btn btn-warning">Editar Plano</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
